 ...
 */
// Iterate over current inventory and compare to new inventory
// If new inventory doesnt exist in current inventory then add new inventory
// If new inventory does exit in current inventory then add new inventory amount to current inventory
